...
from utils import make_mf_regression
...
# make_mf_regression(X ,y, clf, X_t, n_folds=5,seed=seed,nb_epoch=1,max_features=1.0,name='rf_2',path=path)
...
# make_mf_regression(X ,y, clf, X_t, n_folds=5,seed=seed,nb_epoch=1,max_features=1.0,name='et_2',path=path)
...
make_mf_regression(X ,y, clf, X_t, n_folds=5,seed=seed,nb_epoch=1,max_features=1.0,name='lgb_reg',path=path)
...
#         seed = seed,
#         )
# make_mf_regression(X ,y, clf, X_t, n_folds=5,seed=seed,nb_epoch=1,max_features=1.0,name='xgb_2',path=path)
...
# make_mf_regression(X ,y, clf, X_t, n_folds=5,seed=seed,nb_epoch=1,max_features=1.0,name='nn',path=path)
