...
if is_train:
    ...
    with open('../input/train.pattern.onehot.pkl', 'w') as fo:
        pickle.dump(train_oh_features, fo)
    with open('../input/train.pattern.pkl', 'w') as fo:
    ...
    logger.info('Back up features')
    with open('../input/test.pattern.onehot.pkl', 'w') as fo:
        pickle.dump(test_oh_features, fo)
    with open('../input/test.pattern.pkl', 'w') as fo:
