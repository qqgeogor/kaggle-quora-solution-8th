...
ft = ['question1_distinct_bigram','question2_distinct_bigram']
train = pd.read_csv(path+"train_distinct_bigram.csv")[ft]

test = pd.read_csv(path+"test_distinct_bigram.csv")[ft]
...
feats= ['question1_distinct_bigram','question2_distinct_bigram']
