...
ft = ['question1_unigram_question2_hash','question1_hash_question2_unigram']
train = pd.read_csv(path+"train_cooccurrence_qid.csv")[ft]
test = pd.read_csv(path+"test_cooccurrence_qid.csv")[ft]
...
feats= ['question1_unigram_question2_hash','question1_hash_question2_unigram']
