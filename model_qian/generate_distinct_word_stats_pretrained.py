...
prepare_distinct(path+'train.csv',path+'train_distinct_word_stats_pretrained.csv',model)
prepare_distinct(path+'test.csv',path+'test_distinct_word_stats_pretrained.csv',model)
