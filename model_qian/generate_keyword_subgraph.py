...
# pickle.dump(keywords,open(path+'keywords.pkl','wb'))

# keywords = pickle.load(open(path+'keywords.pkl','rb'))

prepared_unigram_subgraph(path+'train_unigram.csv',path+'train_unigram_topic.csv',keywords)
prepared_unigram_subgraph(path+'test_unigram.csv',path+'test_unigram_topic.csv',keywords)
