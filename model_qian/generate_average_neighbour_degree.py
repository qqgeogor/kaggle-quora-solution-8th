...
prepare_hash_subgraph(path+'train_hashed.csv',path+'train_hashed_avg_degrees.csv',avg_degrees)
prepare_hash_subgraph(path+'test_hashed.csv',path+'test_hashed_avg_degrees.csv',avg_degrees)
