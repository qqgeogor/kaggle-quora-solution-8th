...
pd.to_pickle(te_pred,'stack/lgb_model3.train')
print best_it
dall=lgb.Dataset(X_train,y)
clf=lgb.train(params,dall,num_boost_round=best_it)
pd.to_pickle(clf,'model/stack_lgb3.model')
...
pd.to_pickle(ans,'stack/lgb_model3.test')
# In[ ]:

#res.to_csv('res/lgb_5_9_v2.csv',index=False)
...
#res.to_csv('res/lgb_5_9_v2_adj.csv',index=False)
