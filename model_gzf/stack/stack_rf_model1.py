...
# In[30]:
clf=RandomForestClassifier(n_estimators=2000,max_depth=20,random_state=1123,
                              n_jobs=10,min_weight_fraction_leaf=0,criterion='gini',
                              min_samples_leaf=2)
...
pd.to_pickle(te_pred,'stack/rf_model1.train')
#print best_it
clf.fit(X_train,y)
pd.to_pickle(clf,'model/rf_5_11.model')
...
pd.to_pickle(ans,'stack/rf_model1.test')
# In[ ]:
