...
for ind_tr, ind_te in skf:
    #break
    clf=ExtraTreesClassifier(n_estimators=1000, criterion='gini', max_depth=None,
                     min_samples_split=20, min_samples_leaf=1, min_weight_fraction_leaf=0.0,
                     max_features='auto', max_leaf_nodes=None, 
                      n_jobs=14, random_state=1123, verbose=0,
...
res.to_csv('res/et_6_7_meta_v1.csv',index=False)
...
res.to_csv('res/et_6_7_meta_v1_adj.csv',index=False)
