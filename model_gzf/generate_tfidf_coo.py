...
ft = ['question1_unigram_question2_unigram']
train = pd.read_csv(path+"train_cooccurrence_unigram.csv")[ft]
test = pd.read_csv(path+"test_cooccurrence_unigram.csv")[ft]

len_train = train.shape[0]

print('Generate tfidf')
feats= ['question1_unigram_question2_unigram']
tfidf__norm = "l2"
tfidf__max_df = 0.75
tfidf__min_df = 3
